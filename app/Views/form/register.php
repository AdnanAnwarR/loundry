...
<head>
  ...
  <title>Register - E-Loundry</title>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Lengkapi data diri Anda di bawah ini</p>
                    
                    <?php if(session()->getFlashdata('errors')): ?>
                        <div class="alert alert-danger text-center px-3 py-2 small">
                  ...
                  <form class="row g-3 needs-validation" action="<?= base_url('register/process') ?>" method="post">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <label for="yourPhone" class="form-label">Nomor Handphone</label>
                      <input type="text" name="no_hp" class="form-control" id="yourPhone" value="<?= old('no_hp') ?>" required>
